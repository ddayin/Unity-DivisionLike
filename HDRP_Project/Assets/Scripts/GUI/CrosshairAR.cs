...
namespace DivisionLike {
  ...
  public class CrosshairAR : CrosshairHandler {
    ...
    private void UpdateCrosshair() {
      ...
      m_CrosshairImages[0].rectTransform.localPosition = Vector3.Slerp(m_CrosshairImages[0].rectTransform.localPosition,
        new Vector3(0f, crossHairSize, 0f), Time.deltaTime * 8f);
      m_CrosshairImages[1].rectTransform.localPosition = Vector3.Slerp(m_CrosshairImages[1].rectTransform.localPosition,
        new Vector3(crossHairSize, 0f, 0f), Time.deltaTime * 8f);
      m_CrosshairImages[2].rectTransform.localPosition = Vector3.Slerp(m_CrosshairImages[2].rectTransform.localPosition,
        new Vector3(-crossHairSize, 0f, 0f), Time.deltaTime * 8f);
      m_CrosshairImages[3].rectTransform.localPosition = Vector3.Slerp(m_CrosshairImages[3].rectTransform.localPosition,
        new Vector3(0f, -crossHairSize, 0f), Time.deltaTime * 8f);
    }
