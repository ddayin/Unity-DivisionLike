...
namespace Lean.Gui.Inspector
{
	...
	public class LeanSelectionHighlight_Inspector : Lean.Common.LeanInspector<LeanSelectionHighlight>
	{
		protected override void DrawInspector()
		{
			...
			Draw("showTransitions", "This allows you to perform a transition when the highlight begins. You can create a new transition GameObject by right clicking the transition name, and selecting Create. For example, the <b>LeanGraphicColor (Graphic.color Transition)</b> component can be used to change the color.\n\nNOTE: Any transitions you perform here must be reverted in the Hide Transitions setting using a matching transition component.");
			Draw("hideTransitions", "This allows you to perform a transition when the highlight ends. You can create a new transition GameObject by right clicking the transition name, and selecting Create. For example, the <b>LeanGraphicColor (Graphic.color Transition)</b> component can be used to change the color.\n\nNOTE: Any transitions you perform here must be reverted in the Show Transitions setting using a matching transition component.");
