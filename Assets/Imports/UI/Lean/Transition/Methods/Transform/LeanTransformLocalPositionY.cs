...
namespace Lean.Transition.Method
{
	...
	[AddComponentMenu(LeanTransition.MethodsMenuPrefix + "Transform/Transform.localPosition.y" + LeanTransition.MethodsMenuSuffix + "(LeanTransformLocalPositionY)")]
	public class LeanTransformLocalPositionY : LeanMethodWithStateAndTarget
	{
		...
		public class State : LeanStateWithTarget<Transform>
		{
			...
			public override int CanFill
			{
				get
				{
					return Target != null && Target.localPosition.y != Position ? 1 : 0;
				}
			}
